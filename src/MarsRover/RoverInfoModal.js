  ...
  return(
    <div id="roverModal" className="ui basic modal  animated zoomIn">
      ...
      <div className="roverModalBody">
        ...
        <p className="roverModalTitle">NASA's rovers</p>
        <div className="curiosityCon">
        ...
        <div className="spandoppCon">
          <img className="roverPic2" src={require("../Images/spiritandopp.png")} alt="sprit and opportunity" />
